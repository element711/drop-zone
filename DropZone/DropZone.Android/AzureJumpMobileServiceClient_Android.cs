...
[assembly: Dependency(typeof(AzureJumpMobileServiceClient_Android))]
namespace DropZone.Droid
{
    /// <summary>
    /// Responsible for saving and loading jump item data using Azure mobile services.
    /// </summary>
    public class AzureJumpMobileServiceClient_Android : Java.Lang.Object, IAzureJumpMobileServiceClient
    {
        /// <summary>
        /// Gets the jump items.
        /// </summary>
