    ...
    public class FakeRepository : IRepository
    {
        ...
        private static IList<IJump> CreateTestJumps()
        {
            return new List<IJump>
            {
                ...
                new Jump("AFF Level 6", DateTime.Now.AddDays(-5), "76 Green Rd, Helensville, Parakai, New Zealand", _allAircraft.Skip(2).First(), 13000, _jumpTypes.Skip(1).First(), 50, 0, "Telesis 260", "Excellent clib out - goodexit count.", new Uri("https://skydivesandiego.com/wp-content/uploads/2009/09/soloJumping1.jpg")),
                new Jump("AFF Level 7", DateTime.Now.AddDays(-4), "76 Green Rd, Helensville, Parakai, New Zealand", _allAircraft.Skip(3).First(), 12000, _jumpTypes.Skip(1).First(), 50, 0, "Telesis 260", "Good. Good. Good. Good. Good. Good.", new Uri("http://i.vimeocdn.com/video/298414933_640.jpg")),
                new Jump("AFF Level 8", DateTime.Now.AddDays(-3), "Skydive Queenstown", _allAircraft.Skip(3).First(), 13500, _jumpTypes.Skip(1).First(), 50, 0, "Telesis 260", "Could be better. Could be better. Could be better. Could be better.", new Uri("http://i.vimeocdn.com/video/267802283_640.jpg")),
                new Jump("AFF Level 9", DateTime.Now.AddDays(-2), "Skydive Sydney North Coast", _allAircraft.Skip(4).First(), 12500, _jumpTypes.Skip(1).First(), 50, 0, "Telesis 260", "Minor hesitation. Minor hesitation. Minor hesitation.", new Uri("http://i.vimeocdn.com/video/468821994_640.jpg")),
                new Jump("AFF Level 10", DateTime.Now.AddDays(-1), "Skydive Sydney North Coast", _allAircraft.Skip(5).First(), 12200, _jumpTypes.Skip(1).First(), 50, 0, "Telesis 260", "Great jump. Great jump. Great jump. ", new Uri("http://i.vimeocdn.com/video/443254475_640.jpg"))
            };
